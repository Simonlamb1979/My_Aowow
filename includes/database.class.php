...
class DB
{
    ...
    public static function connect(int $idx) : void
    {
        ...
        // Increase range optimizer memory limit to handle complex queries
        $interface->query('SET SESSION range_optimizer_max_mem_size = 16777216'); // 16MB instead of default 8MB
